#!/bin/bash
# =============================================================================
# Qwen3.5-4B SFT 训练启动脚本
# =============================================================================
# 自动检测 GPU 数量，选择单卡或多卡配置
# 使用方法:
#   单卡: CUDA_VISIBLE_DEVICES=0 bash scripts/run_sft_qwen35.sh
#   双卡: CUDA_VISIBLE_DEVICES=0,1 bash scripts/run_sft_qwen35.sh
#   4-bit 量化: USE_4BIT=true CUDA_VISIBLE_DEVICES=0 bash scripts/run_sft_qwen35.sh
# =============================================================================
